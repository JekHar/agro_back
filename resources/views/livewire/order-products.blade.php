<div>
    <div class="block block-rounded mb-2">
        ...
        <div class="block-content">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-vcenter">
                        ...
                        @foreach($selectedProducts as $index => $product)
                            <tr>
                                <td>
                                    <select wire:model.live="selectedProducts.{{ $index }}.product_id" class="form-select">
                                ...
                                <td class="text-center">
                                    <span class="fw-bold">{{ number_format($product['total_quantity_to_use'] ?? 0, 2) }}</span>
                                </td>
                                <td class="text-center">
                                    <span class="fw-bold">{{ number_format($product['calculated_dosage'] ?? 0, 2) }}</span>
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    <span class="fw-bold">{{ number_format($product['product_difference'] ?? 0, 2) }}</span>
                                </td>
                                <td class="text-center">
                                    <input type="text"
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <button type="button" class="btn btn-outline-primary" wire:click="addProduct" {{ !$clientId ? 'disabled' : '' }}>
